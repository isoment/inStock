                        ...
                        <div class="form-div">
                            <form action="/orders/{{$order->id}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="my-2">Customer Originally Ordered: {{$order->product_name}}</div> 
                                    <select class="form-control" id="product" name="product">
                                        <option hidden disabled selected value> -- Select Product -- </option>
                                ...
                                @enderror
                                <div class="form-group">
                                    <label for="item_cost" class="font-weight-light">Item Cost</label>
                                    <div class="d-flex align-items-center">
                                        <div class="font-weight-light">$</div>
                                        <input type="text" class="form-control ml-2" id="item_cost" name="item_cost" value="{{$order->item_cost}}">
                                    </div>
                                </div>
